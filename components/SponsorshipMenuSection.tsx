...
export function SponsorshipMenuSection({
  menus,
  onOpenDetail,
}: SponsorshipMenuSectionProps) {
  return (
    <section id="menu" className="py-24 bg-white">
      <div className="container mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 p-8 md:p-10 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-[3rem] text-white flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden">
          ...
          <a
            className="px-10 py-5 bg-white text-blue-700 rounded-2xl font-bold text-lg hover:bg-blue-50 transition-all whitespace-nowrap shadow-xl relative z-10 w-full lg:w-auto text-center"
