...
※詳しくは掲載イメージ（技大祭協賛広告サイズ・金額表）をご確認ください
...
特典内容・有効期限・店舗名などは貴社にてご検討いただき、券面デザインは実行委員会でご用意いたします。ご希望の場合は、パンフレット広告の応募・入稿時にお申し付けください。なお、クーポンの応募締め切りはパンフレット広告と同様の2026年7月3日(金)です。`,
  ...
  // のぼり広告
  {
    ...
    category: "会場",
    desc: "技大祭当日の会場内に、貴社のロゴとお名前を掲載した縦型のぼりを来場者動線などPR効果の高い場所に設置いたします。",
    details: [
...
※のぼりデザインは昨年度のイメージです。`,
  ...
  // うちわ広告
  {
    ...
    recruitmentClosedMessage:
      "応募多数のため定員に達し、2026年5月15日(金)をもって新規の募集を終了いたしました。お申し込みありがとうございました。お申し込み済みの企業様には、実行委員会より順次ご連絡いたします。",
    desc: "協賛者様の広告をうちわ片面に印刷し、当日受付・イベント時等で来場者へ配布させていただきます。熱中症対策としても活用されます。",
    details: [
      "※定員に達したため、新規の募集を終了しました（2026年5月15日時点）",
      "¥60,000／1,000枚・片面掲載、当日受付・イベント時配布",
      "提出期限：2026年7月31日(金)",
    ],
    detailText: `【募集について】
応募多数のため定員に達し、2026年5月15日(金)をもって新規の募集を終了いたしました。
...
※詳細は下記リンクよりご確認ください`,
  ...
  【協賛金額】
  一口 ¥20,000 先着6口（技大祭最終日までに1万回以上インプレッション保証）
